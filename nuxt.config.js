export default {
  ...
  plugins: [
    { src: '~/plugins/persistedstate.js', srr: false },
      ...
      imports: [
        {
          ...
          icons: ['faChevronRight', 'faChevronDown', 'faUsers', 'faPlus', 'faBell', 'faUser', 'faCog', 'faHome', 'faUnlockAlt', 'faEye', 'faSignOutAlt', 'faSearch', 'faTimes', 'faCrown', 'faCheck']
        }
      ]
    }],
  ],
